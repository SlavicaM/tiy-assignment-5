...
var output; //hold the output values
    ...
    for (var i = 1; i <= 100; i++) {
        ...
        if (((i % 3) == 0 ) &&  ((i % 10) == 0 )){
            output = "FizzBuzz";
            console.log(output); // Case 1: print out the  "FizzBuzz"
         }
        else if ((i % 3) == 0 ){
            output = "Fizz";
            console.log(output); // Case 2: print out the  "Fizz"
         }
        else if  ((i % 10) == 0 ){
            output = "Buzz";
            console.log(output); // Case 2: print out the  "Buzz"
         }
        else {
            output = '11';
            console.log(output); // Case 2: print out the  "Fizz"
